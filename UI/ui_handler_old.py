...
class HandlerClass:
    ...
    def init_preferences(self):
        ...
        self.last_loaded_program = self.w.PREFS_.getpref(
            'last_loaded_directory', None, str, 'BOOK_KEEPING')
        self.last_loaded_program = self.w.PREFS_.getpref(
        ...
        self.w.dSbox_pos1_x.setValue(
            self.w.PREFS_.getpref("x", 10, float, "SAVE_POS1"))
        self.w.dSbox_pos1_y.setValue(
            self.w.PREFS_.getpref("y", 10, float, "SAVE_POS1"))
        self.w.dSbox_pos1_z.setValue(
            self.w.PREFS_.getpref("z", 10, float, "SAVE_POS1"))

        self.w.dSbox_pos2_x.setValue(
            self.w.PREFS_.getpref("x", 10, float, "SAVE_POS2"))
        self.w.dSbox_pos2_y.setValue(
            self.w.PREFS_.getpref("y", 10, float, "SAVE_POS2"))
        self.w.dSbox_pos2_z.setValue(
            self.w.PREFS_.getpref("z", 10, float, "SAVE_POS2"))
    ...
    def set_hal_pin(self):
        ...
        saturation_time_b = self.w.PREFS_.getpref("saturation_time_a", 0, int, "Installation_Parameters")
    ...
    def closing_cleanup__(self):
        ...
        self.w.PREFS_.putpref("dsb_step_x", self.w.dsb_step_x.value(), float, "CAM")
        ...
        self.w.PREFS_.putpref("dsb_radius_2", self.w.dsb_radius_2.value(), float, "CAM")
        ...
        time.sleep(12)
        print('CCCCCCCLLLLLLLLLLLOOOOOOOSSSSSSSEEEEEEEDDDDDDDD')
